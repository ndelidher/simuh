<?php $__env->startSection('title', ($mode=='create'?'Tambah':'Edit') . ' PDM'); ?>
<?php $__env->startSection('content'); ?>

<div style="margin-bottom:16px;">
    <div style="display:flex;align-items:center;gap:6px;font-size:12px;color:#718096;margin-bottom:10px;">
        <a href="<?php echo e(route('wilayah.pdm')); ?>" style="color:#3B6D11;text-decoration:none;">Data PDM</a>
        <span>›</span>
        <span><?php echo e($mode=='create' ? 'Tambah' : 'Edit'); ?> PDM</span>
    </div>
    <h1 style="font-size:20px;font-weight:500;"><?php echo e($mode=='create' ? 'Tambah' : 'Edit'); ?> PDM</h1>
</div>

<form method="POST" action="<?php echo e($mode=='create' ? route('wilayah.pdm.store') : route('wilayah.pdm.update', $data)); ?>">
<?php echo csrf_field(); ?>
...
<div style="background:#fff;border:0.5px solid #dde8d5;border-radius:12px;padding:20px;margin-bottom:16px;">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        <div style="grid-column:span 2;">
            ...
            <select name="pwm_id" style="width:100%;height:36px;border:0.5px solid #ccc;border-radius:8px;padding:0 8px;font-size:13px;">
                ...
                <option value="<?php echo e($p->id); ?>" <?php echo e(old('pwm_id', $data->pwm_id ?? '') == $p->id ? 'selected' : ''); ?>><?php echo e($p->nama); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php $__errorArgs = ['pwm_id'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label style="font-size:12px;color:#718096;display:block;margin-bottom:4px;">Kode PDM <span style="color:red;">*</span></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label style="font-size:12px;color:#718096;display:block;margin-bottom:4px;">Nama PDM <span style="color:red;">*</span></label>
...
<div style="display:flex;gap:10px;">
    ...
    <a href="<?php echo e(route('wilayah.pdm')); ?>" style="border:0.5px solid #ccc;background:transparent;border-radius:8px;padding:10px 20px;font-size:14px;color:#718096;text-decoration:none;">Batal</a>
</div>
</form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\simuh\resources\views/wilayah/pdm_form.blade.php ENDPATH**/ ?>