<?php $__env->startSection('title', ($mode=='create'?'Tambah':'Edit') . ' PRM'); ?>
<?php $__env->startSection('content'); ?>

<div style="margin-bottom:16px;">
    <div style="display:flex;align-items:center;gap:6px;font-size:12px;color:#718096;margin-bottom:10px;">
        <a href="<?php echo e(route('wilayah.prm')); ?>" style="color:#3B6D11;text-decoration:none;">Data PRM</a>
        <span>›</span>
        <span><?php echo e($mode=='create' ? 'Tambah' : 'Edit'); ?> PRM</span>
    </div>
    <h1 style="font-size:20px;font-weight:500;"><?php echo e($mode=='create' ? 'Tambah' : 'Edit'); ?> PRM</h1>
</div>

<form method="POST" action="<?php echo e($mode=='create' ? route('wilayah.prm.store') : route('wilayah.prm.update', $data)); ?>">
<?php echo csrf_field(); ?>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;">
        <div>
            ...
            <select id="sel_pwm" onchange="loadPDM(this.value)"
                ...
                <option value="<?php echo e($p->id); ?>" <?php echo e(old('pwm_id', $data?->pcm?->pdm?->pwm_id ?? '') == $p->id ? 'selected' : ''); ?>><?php echo e($p->nama); ?></option>
        ...
        <div>
            ...
            <select id="sel_pdm" onchange="loadPCM(this.value)"
                ...
                <option value="<?php echo e($p->id); ?>" <?php echo e(old('pdm_id', $data?->pcm?->pdm_id ?? '') == $p->id ? 'selected' : ''); ?>><?php echo e($p->nama); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div>
            ...
            <select name="pcm_id" id="sel_pcm"
                ...
                <option value="<?php echo e($p->id); ?>" <?php echo e(old('pcm_id', $data->pcm_id ?? '') == $p->id ? 'selected' : ''); ?>><?php echo e($p->nama); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php $__errorArgs = ['pcm_id'];
...
<div style="display:flex;gap:10px;">
    ...
    <a href="<?php echo e(route('wilayah.prm')); ?>" style="border:0.5px solid #ccc;background:transparent;border-radius:8px;padding:10px 20px;font-size:14px;color:#718096;text-decoration:none;">Batal</a>
</div>
</form>
<?php $__env->stopSection(); ?>
<?php $__env->startPush('scripts'); ?>
<script>
const existingPdmId = <?php echo e($data?->pcm?->pdm_id ?? 'null'); ?>;
const existingPcmId = <?php echo e($data?->pcm_id ?? 'null'); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\simuh\resources\views/wilayah/prm_form.blade.php ENDPATH**/ ?>